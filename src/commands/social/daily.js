...
class Daily extends Command {
  ...
  async run(msg, [member]) {
    ...
    if (member.id !== msg.member.id) {
      if (member.user.bot) throw "Duh! You can't give your daily points to a bot!";

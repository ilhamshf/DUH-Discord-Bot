...
module.exports = new Language("german", "Deutsch", {
  ...
  GUILD_ONLY: "Duh! Du kannst diesen Befehl nur auf einem Server benutzen. Was machst du in meinen DMs?",
  OWNER_ONLY: "Duh! Was tust du? Der Befehl ist nur für meinen Meister!",
  ...
  WELCOME_MESSAGES: [
    ...
    "Hmph, scheint so als wäre **{{user}}**, ein weiterer Duh, beigetreten.",
    "Es ist nicht so, dass ich dich mag oder so.. aber willkommen auf dem Server, **{{user}}**",
    "O-oh, willkommen **{{user}}**. Ich hoffe, ich bringe dich nicht in Verlegenheit.",
    ...
    "**{{user}}**, willkommen auf **{{guild}}**!"
  ],
  GOODBYE_MESSAGES: [
    "Awh, i-ich finde keine Wörter d-dafür, a-aber ich vermisse dich **{{user}}**!",
    "Awh, **{{user}}** hat den Server verlassen.. n-nicht das es mich interessieren würde! Duh!",
    "**{{user}}**.... N-nein...",
  ...
  DAILY_SUCCESS_MESSAGES: [
    ...
    "Du hast gerade **{{amount}}** bekommen? Vielleicht bezahlst du mir mal ein Abendessen **{{user}}**? :wink:",
  ...
  PING_MESSAGES: [
    ...
    "B-Duh, ich habe geantwortet... in nur **{{ms}}ms**.",
    ...
    "B-Duh! Mein Ping ist **{{ms}}ms**! Bist du nun glücklich?"
  ],
  RELOAD_ERR_UNLOAD: [
    "**{{user}}**, ich glaube ich habe es kaputt gemacht... Das ist passiert: **{{response}}**",
    "Da ist ein Fehler, wahrscheinlich deiner! Duh! **{{response}}**"


  ],
  RELOAD_NOT_FOUND: [
    "Eeeh?! **{{user}}**, warum soll ich einen Command finden der nicht existiert? Es war nicht einmal ein Alias.",
    "Was machst du? **{{command}}** existiert nicht! Duh!"

  ],
  RELOAD_MISSING_ARG: [
    "N-nani?! Ich weiß nicht was ich machen soll, du hast mir nichts gegeben!",
    "Duh! Du musst mir einen Befehl zum neulafen geben!"

  ],
  LEVELUP_MESSAGES: [
    "Du bist gerade Level **{{level}}** geworden, Bauer!",
    "YATTA! Du bist ein Level höher gekommen, **{{user}}**! Du bist jetzt Level **{{level}}**, nicht dass das was heißen würde!",
    "E-eh? Du bist ein Level höhergekommen? Gut, du bist Level **{{level}}** jetzt, was nicht heißt das ich dich nun mehr mag, **{{user}}**... Duh.",
    "Hmph, du bist auf Level **{{level}}** aufgestiegen, **{{user}}**. Gut, dass macht keinen Unterschied für mich!",
    "Hyaa~! Du bist ein Level aufgestiegen, **{{user}}**, du bist nun Level **{{level}}**.",
    "**{{user}}**, du Duh. Lass mich nicht zurück, du bist jetzt Level **{{level}}**.",
    "**{{user}}**, vergiss mich nicht, nur weil du jetzt Level **{{level}}** bist!",
    ...
    "Wie kannst du Level **{{level}}** sein? D-du Duh!",
    "B-Duh! Du bist jetzt Level **{{level}}**, jetzt sei frei! D-dummy...",
    "Du bist definitiv Level **{{level}}** du Duh!",

  ],
  COMMAND_STATS_DESCRIPTION: "Hi, ich bin DUH. Der All-in-One Unterhaltungsbot für deinen Server von meinem Meister ilhamshf",
  COMMAND_STATS_TITLE: "DUH - Botstatistiken",
  ...
  COMMAND_8BALL_ASK: "Duh! Was möchtest du fragen?",
  ...
  COMMAND_KICK_BOT: "Duh! Warum möchtest du mich kicken?",
  COMMAND_KICK_SELF: "Duh! Warum möchtest du dich kicken?",
  COMMAND_KICK_OWNER: "Duh! Du kannst den Eigentümer nicht kicken.",
  ...
  COMMAND_SAY_WHAT: "Duh! Was soll ich sagen?",
  ...
  COMMAND_ANNOUNCEMENTS_FOOTER: (prefix) => `Von der DUH Lounge (Benutz ${prefix}support um uns beizutreten)`,
  COMMAND_SUPPORT_DESCRIPTION: "Hol dir den Link zu unserem Support-Server",
  COMMAND_SUPPORT_TITLE: "Tritt der DUH Lounge bei.",
  ...
  COMMAND_LYRICS_WHAT: "Duh! Nach welchem Song suchst du?",

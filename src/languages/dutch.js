...
module.exports = new Language("dutch", "Nederlands", {
  ...
  OWNER_ONLY: "Stod! Wat denk je dat je aan het doen bent? Die commando is alleen voor mijn meester!",
  GUILD_ONLY: "Stod! U kunt deze commando alleen in een server gebruiken. Wat doe je in mijn directe berichten?",
  ...
  COMMAND_STATS_DESCRIPTION: "Hallo, ik ben DUH. alles in één entertainment bot voor uw server gebracht aan u door mijn meester ilhamshf",
  COMMAND_ANNOUNCEMENTS_TITLE: "Bot-aankondigingen!",
  COMMAND_ANNOUNCEMENTS_FOOTER: (prefix) => `Van DUH Lounge (gebruik ${prefix}support om bij ons te voegen)`,
  COMMAND_SAY: "Ik zal zeggen wat je wilt",
  COMMAND_SAY_WHAT: "Stod! Wat wil je dat ik zeg?",

...
module.exports = new Language("french", "Français", {
  ...
  COMMAND_STATS_DESCRIPTION: "Salut, je suis DUH. Le bot de divertissement tout-en-un pour votre serveur vous a apporté par mon maître ilhamshf",
  COMMAND_STATS_TITLE: "DUH - Statistiques de bot",

...
module.exports = new Language("english", "English", {
  ...
  GUILD_ONLY: "Duh! You can only use this command in a server. What are you doing in my DMs?",
  OWNER_ONLY: "Duh! What do you think you're doing? That command is only for my master!",
  ...
  NONE: "None",
  SECONDS: "Seconds",
  BLACKLISTED: "You've been blacklisted from using the bot for abusive reasons. Please join https://discord.gg/mDkMbEh or contact ilhamshf for a chance to appeal.",
  BLACKLISTED_GUILD: (guild) => `The server **${guild.name}** has been blacklisted from using the bot. If you are an Admin of the server please join https://discord.gg/mDkMbEh or contact ilhamshf for a chance to appeal.`,
  ...
  COMMAND_STATS_DESCRIPTION: "Hi, I'm DUH. The all-in-one entertainment bot for your server brought to you by my master ilhamshf",
  COMMAND_STATS_TITLE: "DUH - Bot Statistics",
  ...
  COMMAND_8BALL_ASK: "Duh! What do you want to ask?",
  ...
  COMMAND_KICK_BOT: "Duh! Why would you kick me?",
  COMMAND_KICK_SELF: "Duh! Why would you kick yourself?",
  COMMAND_KICK_OWNER: "Duh! You can't kick the owner.",
  ...
  COMMAND_SAY_WHAT: "Duh! What do you want me to say?",
  ...
  COMMAND_ANNOUNCEMENTS_FOOTER: (prefix) => `From DUH Lounge (Use ${prefix}support to join us)`,
  COMMAND_SUPPORT_DESCRIPTION: "Get the link to our support server.",
  COMMAND_SUPPORT_TITLE: "Join DUH Lounge",
  ...
  COMMAND_LYRICS_WHAT: "Duh! What song are you looking for?",
